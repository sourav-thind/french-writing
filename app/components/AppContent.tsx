...
export default function AppContent() {
    ...
    return (
      <div className="min-h-screen bg-stone-50 dark:bg-neutral-950 flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          <div className="w-8 h-8 border-2 border-stone-300 dark:border-neutral-600 border-t-indigo-600 dark:border-t-indigo-400 rounded-full animate-spin"></div>
          <p className="text-stone-500 dark:text-neutral-300 text-sm">Chargement...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 border border-stone-200 dark:border-neutral-700">
                <div className="flex items-center justify-between">
                  ...
                  <label className="cursor-pointer px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white text-sm font-medium rounded-xl hover:shadow-lg hover:shadow-neutral-500/25 transition-all flex items-center gap-2">
  ...
  return (
    <>
      <Header />
      <main className="pt-16">
        <div className="min-h-screen bg-stone-50 dark:bg-neutral-950 flex flex-col items-center justify-center p-6">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-semibold text-stone-800 dark:text-white mb-3">
              L&apos;Atelier d&apos;Écriture
            </h1>
            <p className="text-stone-500 dark:text-neutral-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full max-w-2xl">
            ...
            >
              ...
              <p className="text-stone-500 dark:text-neutral-300 text-sm leading-relaxed">Dictées interactives pour améliorer votre orthographe et votre écoute.</p>
            </button>
            ...
            >
              ...
              <p className="text-stone-500 dark:text-neutral-300 text-sm leading-relaxed">Corrections assistées par intelligence artificielle.</p>
            </button>
          </div>

          <footer className="mt-20 text-stone-400 dark:text-neutral-500 text-sm">

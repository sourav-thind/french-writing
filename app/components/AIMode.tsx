      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          >
            ...
            <p className="text-stone-500 dark:text-indigo-300 text-sm leading-relaxed">Pratiquez avec des sujets spécifiques à l&apos;examen TEF CANADA.</p>
          </button>
          ...
          >
            ...
            <p className="text-stone-500 dark:text-indigo-300 text-sm leading-relaxed">Écrivez librement et obtenez des corrections personnalisées.</p>
          </button>
        </div>
      </div>
    </div>
